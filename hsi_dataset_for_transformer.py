...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_data = np.concatenate((bgr, hyper), axis=0)       #sumeet
        c,h,w = image_data.shape                                #sumeet
        image_data = image_data.reshape(c, h*w)                 #sumeet
        return np.ascontiguousarray(image_data)                 #sumeet
